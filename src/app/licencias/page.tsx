    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#f7f7f6" }}>
      ...
      <main className="flex-1 mx-auto w-full max-w-5xl px-6 py-10">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          >
            <KeyRound className="w-5 h-5" style={{ color: "#ff4613" }} />
          </div>
          <h2
        ...
        >
          Elige la herramienta y reserva un horario disponible.
        </p>
        ...
        {tools.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {tools.map((tool) => (
              <Link key={tool.id} href={`/licencias/${tool.slug}`} className="group block">
                <div
